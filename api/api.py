...
def login():
    ...
    try:
        ...
        return "Your account has been created. Please wait for your Adeptmind representative to get back to your regarding completion of your account setup. You can close this window.", 200
